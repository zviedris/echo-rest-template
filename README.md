[![Build Status](https://app.travis-ci.com/zviedris/echo-rest-template.svg?branch=main)](https://app.travis-ci.com/zviedris/echo-rest-template)
[![codecov](https://codecov.io/gh/zviedris/echo-rest-template/branch/main/graph/badge.svg?token=hxaHIVyoBN)](https://codecov.io/gh/zviedris/echo-rest-template)
[![License: MIT](https://img.shields.io/badge/License-MIT-yellow.svg)](https://github.com/zviedris/echo-rest-template/blob/master/LICENSE)
[![Go Reference](https://pkg.go.dev/badge/github.com/zviedris/echo-rest-template.svg)](https://pkg.go.dev/github.com/zviedris/echo-rest-template)
[![GoReportCard Badge](https://goreportcard.com/badge/github.com/zviedris/echo-rest-template)](https://goreportcard.com/report/github.com/zviedris/echo-rest-template)
[![Total alerts](https://img.shields.io/lgtm/alerts/g/zviedris/echo-rest-template.svg?logo=lgtm&logoWidth=18)](https://lgtm.com/projects/g/zviedris/echo-rest-template/alerts/)
...
<!--toc-->
- [Echo REST API boilerplate](#echo-rest-template-boilerplate)
    * [Overview](#overview)
    * [Features](#features)
...
> **DO NOT FORK** this is meant to be used from **[Use this template](https://github.com/zviedris/echo-rest-template/generate)** feature.

1. Click on **[Use this template](https://github.com/zviedris/echo-rest-template/generate)**
